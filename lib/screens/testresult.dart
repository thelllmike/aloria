...
import 'package:aloria/screens/utils/global_user.dart'; // Import GlobalUser to access profile picture URL.
import 'package:aloria/screens/firstscreen.dart'; // Import FirstScreen to navigate back.
    ...
    return SliverAppBar(
            ...
            DecoratedBox(
              decoration: BoxDecoration(
                ...
                image: DecorationImage(
                  image: NetworkImage(GlobalUser.profilePictureUrl ?? 'assets/images/test.png'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
      ...
      leading: InkWell(
        onTap: () {
          ...
          ); // Navigates back to FirstScreen on tap
        },
        child: const Padding(
